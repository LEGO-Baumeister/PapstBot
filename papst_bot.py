...
null = ["Bedenke, Mensch, dass du Staub bist und wieder zum Staub zurückkehren wirst.", "Der Tag des jüngsten Gerichts wird kommen.",
        "Vater, vergib ihnen, denn sie wissen nicht, was sie tun.", "Amen, ich sage dir: Heute noch wirst du mit mir im Paradies sein."]
vers = BibleVerse()
...
async def pray(ctx, arg1=None, arg2=None):
    ...
    embed.add_field(
        name="Nutze:", value="+bete < paternoster | credo | avemaria > < de | la | en>")
...
@client.command(aliases=["rndm", "vers", "verse", "bibelvers", "bibleverse"])
async def random(ctx):
    quote = discord.Embed(title="Random Bibelvers")
    quote.add_field(name=vers.get_verse()[1], value=vers.get_verse()[0])
